                        ...
                        <div class="pl-0 pr-0 bg-topmenu">
                            ...
                            <nav class="navbar navbar-expand-md navbar-light w-100 p-0">
                                ...
                                <div id="bs-example-navbar-collapse-2" class="collapse navbar-collapse"><ul id="menu-topmenu" class="nav navbar-nav w-100">
                                        ...
                                        <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-52" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-52 nav-item" style="line-height: 2.4em"><a title="Kontakt" href="<?php echo get_site_url(); ?>/index.php/kontakt/" class="nav-link">Kontakt</a></li>
                                    </ul>
                                </div>
                            </nav>
